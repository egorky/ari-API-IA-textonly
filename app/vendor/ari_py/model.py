...
import re
import requests # This dependency will need to be managed
import logging
...
class Repository(object):
    ...
    :type  client:  client.Client # This will become app.vendor.ari_py.client.Client
    :param name:    Repository name. Maps to the basename of the resource's
                    .json file
    :param resource:    Associated Swagger resource.
    :type  resource:    swaggerpy.client.Resource # This dependency will need to be managed
    """
...
class DeviceState(BaseObject):
    ...
    :param client:  ARI client.
    :type  client:  client.Client # This will become app.vendor.ari_py.client.Client
    :param endpoint_json: Instance data # Should be device_state_json
    """
...
def promote(client, resp, operation_json):
    ...
    :type  resp:    requests.Response # This dependency will need to be managed
